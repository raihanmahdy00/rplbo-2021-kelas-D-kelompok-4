...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Des 2021 pada 05.59
...
(1, 'Majelis Pendidikan Khairul Bariyyah', 'MTs Negeri 10 Pekanbaru', 'Terakreditasi B', 'Jl.  Paus No. 69', 'Edison, S.Ag', '-', 'https://sites.google.com/view/mtsn10pekanbaru', 'mtsn10pekanbaru@gmail.com', 'Logo.png', 1);
...
--
-- Struktur dari tabel `tbl_legalisir`
--

CREATE TABLE `tbl_legalisir` (
  `id_leges` int(10) NOT NULL,
  `no_agenda` int(10) NOT NULL,
  `no_leges` varchar(100) NOT NULL,
  `nama_siswa` varchar(250) NOT NULL,
  `tgl_leges` date NOT NULL,
...
INSERT INTO `tbl_sett` (`id_sett`, `surat_masuk`, `surat_keluar`, `id_leges`, `referensi`, `id_user`) VALUES
(1, 10, 10, 0, 10, 1);
...
(1, 'admin', '865dc4a01a9aff68247da47f37942ff8', 'Raihan Mahdy', '200012142014071002', 1);
...
--
-- Indeks untuk tabel `tbl_legalisir`
--
ALTER TABLE `tbl_legalisir`
  ADD PRIMARY KEY (`id_leges`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_legalisir`
--
ALTER TABLE `tbl_legalisir`
  MODIFY `id_leges` int(10) NOT NULL AUTO_INCREMENT;
