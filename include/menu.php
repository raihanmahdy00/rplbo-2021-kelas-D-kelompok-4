...
<nav class="green darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><img style="width: 120px; margin: 10px;" src="./asset/img/school.png">
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">MTs N 10 Pekanbaru</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. Paus No.69 Pekanbaru</p>';
                            }
                        }
                    ?>
                </div>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="?page=pro&sub=pass">Ganti Password</a></li>
            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">repeat</i> Menu Surat</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=tsm">Surat Masuk</a></li>
                                <li><a href="?page=tsk">Surat Keluar</a></li>
                                <li><a href="?page=lgs">Legalisir</a></li>
                            </ul>
                        </div>
                   </li>
                </ul>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            ...
            <li><img style="width: 120px; margin: 10px;" src="./asset/img/school.png"></li>
            <li><div class="grs"></></li>
            <li><a href="./"><i class="material-icons"></i>&nbsp; Beranda</a></li>
            <?php
                if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3){ ?>
            <li><a class="dropdown-button" href="#!" data-activates="transaksi">Menu Surat <i class="material-icons md-18">arrow_drop_down</i></a></li>
            ...
            ?>
            <li><a class="dropdown-button" href="#!" data-activates="agenda">Laporan Agenda <i class="material-icons md-18">arrow_drop_down</i></a></li>
