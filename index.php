...
<head>
    ...
    <title>RPLBO Surat Menyurat</title>
            ...
            <div class="col s12 m6 offset-m3 offset-m3">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-light green col s12" name="submit">LOGIN</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
